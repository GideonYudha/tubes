...
<nav class="navbar navbar-light navbar-expand-lg navbar-light bg-light fixed-top home">
   <div class="container">
      ...
      <img src="<?= base_url('images/random/logo.png') ?>" width="100" alt="">
      </a>
      ...
      <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
         ...
         <a href="<?= base_url("admin") ?>" class="btn btn-primary">Admin Panel<span class="button"></span></a>
         <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
            ...
            <li class="nav-item">
               <a class="nav-link" href="https://www.instagram.com/gideonyudha/">
